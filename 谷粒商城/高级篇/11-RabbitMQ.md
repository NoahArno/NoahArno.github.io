...
spring.rabbitmq.host=192.168.118.128

spring.rabbitmq.virtual-host=/

3、添加注解@EnableRabbimq
...
spring: 
  rabbitmq:
    ...
    publisher-confirm-type: correlated #开启发送端确认，也就是消息确认抵达到reabbitmq服务器
```

5、使用代码演示消息可靠传递，并且使用JSON序列化机制进行消息的转换
