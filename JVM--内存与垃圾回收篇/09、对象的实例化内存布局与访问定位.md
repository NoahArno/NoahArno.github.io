...
![image-20210830125356389](IMG/09、对象的实例化内存布局与访问定位.assets/image-20210830125356389.png)

## 2、对象创建的方式和步骤

![image-20210830125950217](IMG/09、对象的实例化内存布局与访问定位.assets/image-20210830125950217.png)
...
![image-20210830130203892](IMG/09、对象的实例化内存布局与访问定位.assets/image-20210830130203892.png)
...
![image-20210830130225530](IMG/09、对象的实例化内存布局与访问定位.assets/image-20210830130225530.png)
...
![image-20210830130431500](IMG/09、对象的实例化内存布局与访问定位.assets/image-20210830130431500.png)
...
![image-20210830130447943](IMG/09、对象的实例化内存布局与访问定位.assets/image-20210830130447943.png)
