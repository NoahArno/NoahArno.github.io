...
![image-20210825093704619](IMG/05、虚拟机栈.assets/image-20210825093704619.png)
...
![image-20210825095220429](IMG/05、虚拟机栈.assets/image-20210825095220429.png)
...
- **定义为一个数字数组，主要用于存储方法参数和定义在方法体内的局部变量**，这些数据类型包括各类基本数据类型、对象引用（reference），以及returnAddress返回值类型。
  ...
  > ![image-20210825183353317](IMG/05、虚拟机栈.assets/image-20210825183353317.png)
...
<img src="IMG/05、虚拟机栈.assets/image-20210825184400287.png" alt="image-20210825184400287" style="zoom: 67%;" />
...
- 比如：执行复制、交换、求和等操作
  ...
  ![image-20210825185025622](IMG/05、虚拟机栈.assets/image-20210825185025622.png)
...
![image-20210825195923604](IMG/05、虚拟机栈.assets/image-20210825195923604.png)
...
![img](IMG/05、虚拟机栈.assets/0040.png)
