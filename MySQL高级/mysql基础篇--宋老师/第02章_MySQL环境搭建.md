...
![images/image-20211014154112574.png](IMG/第02章_MySQL环境搭建.assets/image-20211014154112574.png)

⑤ 执行卸载。单击“Execute”（执行）按钮进行卸载。

![images/image-20211014154006530.png](IMG/第02章_MySQL环境搭建.assets/image-20211014154006530.png)

⑥ 完成卸载。单击“Finish”（完成）按钮即可。如果想要同时卸载MySQL8.0的安装向导程序，勾选“Yes，Uninstall MySQL Installer”即可，如图所示。

![images/image-20211014154046268.png](IMG/第02章_MySQL环境搭建.assets/image-20211014154046268.png)
...
![](IMG/第02章_MySQL环境搭建.assets/image-20210817185955123.png)
...
- 这里在Windows 系统下推荐下载`MSI安装程序`；点击`Go to Download Page`进行下载即可
 ...
 ![images/image-20210727192819147.png](IMG/第02章_MySQL环境搭建.assets/image-20210727192819147.png)
...
![images/image-20211014170553535.png](IMG/第02章_MySQL环境搭建.assets/image-20211014170553535.png)
...
![images/image-20211014170638699.png](IMG/第02章_MySQL环境搭建.assets/image-20211014170638699.png)

此时如果直接“Next”（下一步），则产品的安装路径是默认的。如果想要自定义安装目录，则可以选中对应的产品，然后在下面会出现“Advanced Options”（高级选项）的超链接。

![images/image-20211014170814386.png](IMG/第02章_MySQL环境搭建.assets/image-20211014170814386.png)
...
![images/image-20211014170857263.png](IMG/第02章_MySQL环境搭建.assets/image-20211014170857263.png)

步骤4：在上一步选择好要安装的产品之后，单击“Next”（下一步）进入确认窗口，如图所示。单击“Execute”（执行）按钮开始安装。

![images/image-20211014170934889.png](IMG/第02章_MySQL环境搭建.assets/image-20211014170934889.png)

步骤5：安装完成后在“Status”（状态）列表下将显示“Complete”（安装完成），如图所示。

![images/image-20211014171002259.png](IMG/第02章_MySQL环境搭建.assets/image-20211014171002259.png)
...
![images/clip_image002-1634203188594.jpg](IMG/第02章_MySQL环境搭建.assets/clip_image002-1634203188594.jpg)

步骤2：单击“Next”（下一步）按钮，进入MySQL服务器类型配置窗口，如图所示。端口号一般选择默认端口号3306。

![images/clip_image004-1634203188595.jpg](IMG/第02章_MySQL环境搭建.assets/clip_image004-1634203188595.jpg)

其中，“Config Type”选项用于设置服务器的类型。单击该选项右侧的下三角按钮，即可查看3个选项，如图所示。

![images/clip_image006-1634203188595.jpg](IMG/第02章_MySQL环境搭建.assets/clip_image006-1634203188595.jpg)
...
![images/clip_image008-1634203188595.jpg](IMG/第02章_MySQL环境搭建.assets/clip_image008-1634203188595.jpg)
...
![images/clip_image010-1634203188595.jpg](IMG/第02章_MySQL环境搭建.assets/clip_image010-1634203188595.jpg)
...
![images/clip_image012-1634203188596.jpg](IMG/第02章_MySQL环境搭建.assets/clip_image012-1634203188596.jpg)

步骤6：单击“Next”（下一步）按钮，打开确认设置服务器窗口，单击“Execute”（执行）按钮。

![images/clip_image014-1634203188596.jpg](IMG/第02章_MySQL环境搭建.assets/clip_image014-1634203188596.jpg)

步骤7：完成配置，如图所示。单击“Finish”（完成）按钮，即可完成服务器的配置。

![images/clip_image016.jpg](IMG/第02章_MySQL环境搭建.assets/clip_image016.jpg)

步骤8：如果还有其他产品需要配置，可以选择其他产品，然后继续配置。如果没有，直接选择“Next”（下一步），直接完成整个安装和配置过程。

![images/clip_image018.jpg](IMG/第02章_MySQL环境搭建.assets/clip_image018.jpg)

步骤9：结束安装和配置。

![images/clip_image020.jpg](IMG/第02章_MySQL环境搭建.assets/clip_image020.jpg)
...
![images/clip_image002.gif](IMG/第02章_MySQL环境搭建.assets/clip_image002.gif)
...
![images/clip_image004.gif](IMG/第02章_MySQL环境搭建.assets/clip_image004.gif)

![images/clip_image006.gif](IMG/第02章_MySQL环境搭建.assets/clip_image006.gif)
...
![images/image-20211014184037414.png](IMG/第02章_MySQL环境搭建.assets/image-20211014184037414.png)
...
![images/image-20211014184425147.png](IMG/第02章_MySQL环境搭建.assets/image-20211014184425147.png)
...
![images/image-20211014185035137.png](IMG/第02章_MySQL环境搭建.assets/image-20211014185035137.png)
...
![images/MySQL编码1.jpg](IMG/第02章_MySQL环境搭建.assets/MySQL编码1.jpg)

![images/MySQL编码2.jpg](IMG/第02章_MySQL环境搭建.assets/MySQL编码2.jpg)
...
![images/image-20211014195108502.png](IMG/第02章_MySQL环境搭建.assets/image-20211014195108502.png)

![images/image-20211014195129219.png](IMG/第02章_MySQL环境搭建.assets/image-20211014195129219.png)

![images/image-20211014195142849.png](IMG/第02章_MySQL环境搭建.assets/image-20211014195142849.png)
...
![images/1557378069584.png](IMG/第02章_MySQL环境搭建.assets/1557378069584.png)

![images/image-20210913180359685.png](IMG/第02章_MySQL环境搭建.assets/image-20210913180359685.png)
...
![images/image-20211014213018979.png](IMG/第02章_MySQL环境搭建.assets/image-20211014213018979.png)

![images/image-20211014213036470.png](IMG/第02章_MySQL环境搭建.assets/image-20211014213036470.png)
...
![images/image-20211014195237457.png](IMG/第02章_MySQL环境搭建.assets/image-20211014195237457.png)

![images/image-20211014195251371.png](IMG/第02章_MySQL环境搭建.assets/image-20211014195251371.png)

![images/image-20211014195300510.png](IMG/第02章_MySQL环境搭建.assets/image-20211014195300510.png)

![images/image-20211014195309805.png](IMG/第02章_MySQL环境搭建.assets/image-20211014195309805.png)

### 可能出现连接问题：

有些图形界面工具，特别是旧版本的图形界面工具，在连接MySQL8时出现“Authentication plugin 'caching_sha2_password' cannot be loaded”错误。

![images/image-20211019215249254.png](IMG/第02章_MySQL环境搭建.assets/image-20211019215249254.png)
...
![images/image-20211019215408965.png](IMG/第02章_MySQL环境搭建.assets/image-20211019215408965.png)
