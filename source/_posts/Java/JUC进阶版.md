...
![image-20210918141447740](JUC进阶版/image-20210918141447740.png)
...
![image-20210918141837176](JUC进阶版/image-20210918141837176.png)
...
![image-20220124111743340](JUC进阶版/image-20220124111743340.png)
...
![image-20220124115730172](JUC进阶版/image-20220124115730172.png)

可以看到，synchronized实际上使用的是monitorenter和monitorexit两个指令，但是可以看到，上述的代码，两者居然不配对，这是因为得sync的底层会保证该锁最后一定会被释放。

可以手动给m1方法抛出异常

![image-20220124121354189](JUC进阶版/image-20220124121354189.png)
...
![image-20220124121515897](JUC进阶版/image-20220124121515897.png)
...
![image-20220124121848015](JUC进阶版/image-20220124121848015.png)
...
![image-20220128211625979](JUC进阶版/image-20220128211625979.png)
...
![image-20220128214911864](JUC进阶版/image-20220128214911864.png)
...
![image-20220128220519739](JUC进阶版/image-20220128220519739.png)
...
![image-20220128224551893](JUC进阶版/image-20220128224551893.png)
...
![image-20220128225358749](JUC进阶版/image-20220128225358749.png)
...
![image-20220130212634934](JUC进阶版/image-20220130212634934.png)
...
![电脑CPU中的三级缓存是越大越好吗？三级缓存到底有什么用？](JUC进阶版/a32472fe38386792db568898579c8a9ba8cad630.png@903w_917h_progressive.webp)
...
![image-20220201223742035](JUC进阶版/image-20220201223742035.png)
...
![image-20210911143513939](JUC进阶版/image-20210911143513939.png)
...
![image-20210911180726641](JUC进阶版/image-20210911180726641.png)
...
![image-20210911181359988](JUC进阶版/image-20210911181359988.png)
...
![IMG/JUC进阶版.asserts/image-20220203143709073.png](JUC进阶版/image-20220203143709073.png)

它的底层其实就是Unsafe.cpp类

![IMG/JUC进阶版.asserts/image-20220203144527688.png](JUC进阶版/image-20220203144527688.png)

再看OrderAccess.hpp类：

![IMG/JUC进阶版.asserts/image-20220203144601489.png](JUC进阶版/image-20220203144601489.png)

orderAccess_linux_x86.inline.hpp：

![IMG/JUC进阶版.asserts/image-20220203144627544.png](JUC进阶版/image-20220203144627544.png)
...
![IMG/JUC进阶版.asserts/image-20220203155841704.png](JUC进阶版/image-20220203155841704.png)
...
![IMG/JUC进阶版.asserts/image-20220203164803880.png](JUC进阶版/image-20220203164803880.png)

- 在每个volatile读操作的后面插入一个LoadLoad屏障
- 在每个volatile读操作的后面插入一个LoadStore屏障

![IMG/JUC进阶版.asserts/image-20220203165011738.png](JUC进阶版/image-20220203165011738.png)

### 6.3 volatile特性

**禁止指令重排小总结**（了解）

![image-20210911181631789](JUC进阶版/image-20210911181631789.png)

![image-20210911181636446](JUC进阶版/image-20210911181636446.png)
...
![img](JUC进阶版/64c955c65010aae3902ec918412827d8.png)
...
![尚硅谷面试题/IMG/尚硅谷面试题第二季.assets/image-20210911203702980.png  100644 → 0](JUC进阶版/image-20210911203702980.png)
...
![image-20210911211528787](JUC进阶版/image-20210911211528787.png)

![image-20210911211532186](JUC进阶版/image-20210911211532186.png)

![image-20210911211535551](JUC进阶版/image-20210911211535551.png)
...
![image-20220206103406684](JUC进阶版/image-20220206103406684.png)

![image-20220206103423934](JUC进阶版/image-20220206103423934.png)
...
![image-20220206113432949](JUC进阶版/image-20220206113432949.png)
...
![image-20220206114644660](JUC进阶版/image-20220206114644660.png)

#### **4、源码、原理分析**

![image-20220206134057810](JUC进阶版/image-20220206134057810.png)
...
![image-20220206134940151](JUC进阶版/image-20220206134940151.png)
...
![image-20220206135334565](JUC进阶版/image-20220206135334565.png)
...
![image-20220206135356216](JUC进阶版/image-20220206135356216.png)
...
![image-20220206135838869](JUC进阶版/image-20220206135838869.png)
...
![image-20220206204659299](JUC进阶版/image-20220206204659299.png)

![image-20220206204712443](JUC进阶版/image-20220206204712443.png)

![image-20220206204716485](JUC进阶版/image-20220206204716485.png)

![image-20220206204721049](JUC进阶版/image-20220206204721049.png)

**接下来看总纲**

![image-20220206204805772](JUC进阶版/image-20220206204805772.png)
...
![image-20220206205242031](JUC进阶版/image-20220206205242031.png)
...
![image-20220206205314265](JUC进阶版/image-20220206205314265.png)
...
![image-20220206205342462](JUC进阶版/image-20220206205342462.png)

**3.1**

![image-20220206211522791](JUC进阶版/image-20220206211522791.png)

上面代码判断当前线程hash后指向的数据位置元素是否为空，如果为空则将Cell数据放入数组中，跳出循环。如果不空则继续循环。

**3.2**

![image-20220206211544806](JUC进阶版/image-20220206211544806.png)

**3.3**

![image-20220206211555812](JUC进阶版/image-20220206211555812.png)

说明当前线程对应的数组中有了数据，也重置过hash值，这时通过CAS操作尝试对当前数中的value值进行累加x操作，x默认为1，如果CAS成功则直接跳出循环。

**3.4**

![image-20220206211615943](JUC进阶版/image-20220206211615943.png)

**3.5**

![image-20220206211624502](JUC进阶版/image-20220206211624502.png)

**3.6**

![image-20220206211632200](JUC进阶版/image-20220206211632200.png)

**上述六部总结如下**

![image-20220206211645742](JUC进阶版/image-20220206211645742.png)
...
![image-20220206211930658](JUC进阶版/image-20220206211930658.png)
...
![image-20220205125505913](JUC进阶版/image-20220205125505913.png)
...
![image-20220205125656777](JUC进阶版/image-20220205125656777.png)

### 10.1.1 对象头

**对象头包含对象标记（Mark Word）和类元信息（又叫类型指针）**

![image-20220205130518985](JUC进阶版/image-20220205130518985.png)
...
![image-20220205132040145](JUC进阶版/image-20220205132040145.png)
...
![image-20220205132454203](JUC进阶版/image-20220205132454203.png)
...
![image-20220205132832941](JUC进阶版/image-20220205132832941.png)

![image-20220205132859119](JUC进阶版/image-20220205132859119.png)

![image-20220205133200557](JUC进阶版/image-20220205133200557.png)

![image-20220205133206455](JUC进阶版/image-20220205133206455.png)
...
![image-20220205133815247](JUC进阶版/image-20220205133815247.png)
...
![image-20220205134512658](JUC进阶版/image-20220205134512658.png)
...
![image-20220205141630791](JUC进阶版/image-20220205141630791.png)
...
![image-20220205144231834](JUC进阶版/image-20220205144231834.png)
...
![image-20220205152216749](JUC进阶版/image-20220205152216749.png)

### 11.3 偏向锁

![image-20221109214027087](JUC进阶版/image-20221109214027087.png)
...
![image-20220205152510684](JUC进阶版/image-20220205152510684.png)
...
![image-20220205213034003](JUC进阶版/image-20220205213034003.png)
...
![image-20220205213144978](JUC进阶版/image-20220205213144978.png)
...
![image-20220205215228013](JUC进阶版/image-20220205215228013.png)
...
![image-20210923185707622](JUC进阶版/image-20210923185707622.png)

和AQS有关的内容如下图所示

![image-20210923113321814](JUC进阶版/image-20210923113321814.png)
...
![image-20210923201402008](JUC进阶版/image-20210923201402008.png)
...
![image-20210923203705089](JUC进阶版/image-20210923203705089.png)
...
![image-20210923210904175](JUC进阶版/image-20210923210904175.png)
...
![image-20210923211027125](JUC进阶版/image-20210923211027125.png)
...
![image-20210923213116201](JUC进阶版/image-20210923213116201.png)

双向链表中，**第一个节点为虚节点，也叫哨兵节点**，其实并不存储任何信息，只是占位。真正的第一个有数据的节点，是从第二个节点开始的。

此时方法还没结束，继续下一次循环，注意的是，此时tail已经不为null了，进入else中，而此时的node就是线程B所在的节点，将线程B加入到CLH队列之中。

![image-20220224214430039](JUC进阶版/image-20220224214430039.png)

然后这时候C线程也进来了，重复线程B的动作，但是在addWaiter方法能进if里面， 此时将线程C也添加进CLH队列中

![image-20220224214444508](JUC进阶版/image-20220224214444508.png)
...
![image-20220224214500823](JUC进阶版/image-20220224214500823.png)
...
![image-20220205215707623](JUC进阶版/image-20220205215707623.png)
...
![image-20220205221301989](JUC进阶版/image-20220205221301989.png)
...
![image-20220205221840288](JUC进阶版/image-20220205221840288.png)

在ReentrantReadWriteLock中，当读锁被使用时，如果有线程尝试获取写锁，该写线程会被阻塞。

所以，需要释放所有读锁，才可获取写锁，

![image-20220205221856490](JUC进阶版/image-20220205221856490.png)
...
![image-20220205222241508](JUC进阶版/image-20220205222241508.png)
