...
![image-20220504183404624](IMG/JVM.assets/image-20220504183404624.png)
...
![image-20220504184253091](IMG/JVM.assets/image-20220504184253091.png)
...
![IMG/04、程序计数器.assets/image-20210821200606763.png](IMG/JVM.assets/image-20210821200606763.png)
...
![image-20210825195923604](IMG/JVM.assets/image-20210825195923604.png)
...
![image-20210830110159922](IMG/JVM.assets/image-20210830110159922.png)

**JDK7**

方法区由永久代实现，使用 JVM 虚拟机内存

![image-20210830110221095](IMG/JVM.assets/image-20210830110221095.png)

**JDK8**

方法区由元空间实现，使用物理机本地内存

![image-20210830110251768](IMG/JVM.assets/image-20210830110251768.png)
...
![image-20210830124820775](IMG/JVM.assets/image-20210830124820775.png)

# 第三章 对象的实例化内存布局与访问定位

## 对象的实例化

![image-20210830125356389](IMG/JVM.assets/image-20210830125356389.png)

## 对象创建的方式和步骤

![image-20210830125950217](IMG/JVM.assets/image-20210830125950217.png)
...
![image-20210830130203892](IMG/JVM.assets/image-20210830130203892.png)
...
![image-20210830130225530](IMG/JVM.assets/image-20210830130225530.png)
...
![image-20210830130431500](IMG/JVM.assets/image-20210830130431500.png)
...
![image-20210830130447943](IMG/JVM.assets/image-20210830130447943.png)
...
![img](IMG/JVM.assets/0038.png)

**直接缓冲区（NIO）**

NIO 直接操作物理磁盘，省去了中间过程

![img](IMG/JVM.assets/0039.png)
...
![image-20210904154047916](IMG/JVM.assets/image-20210904154047916.png)
...
![image-20210905112032806](IMG/JVM.assets/image-20210905112032806.png)
...
![image-20210905112236173](IMG/JVM.assets/image-20210905112236173.png)

Java字节码的执行是由JVM执行引擎来完成，流程图如下图所示：

![image-20210905112340252](IMG/JVM.assets/image-20210905112340252.png)
...
![image-20210905113306187](IMG/JVM.assets/image-20210905113306187.png)
...
![image-20210905140917696](IMG/JVM.assets/image-20210905140917696.png)
...
![img](IMG/JVM.assets/0013-16516626421232.png)

JDK7以及以后：

![img](IMG/JVM.assets/0014.png)
...
![IMG/13、垃圾回收概述和垃圾回收算法.assets/image-20210909162516777.png](IMG/JVM.assets/image-20210909162516777.png)
...
![IMG/13、垃圾回收概述和垃圾回收算法.assets/0029.png](IMG/JVM.assets/0029.png)
...
![IMG/13、垃圾回收概述和垃圾回收算法.assets/0030.png](IMG/JVM.assets/0030.png)
...
![IMG/13、垃圾回收概述和垃圾回收算法.assets/0032.png](IMG/JVM.assets/0032.png)
...
![IMG/13、垃圾回收概述和垃圾回收算法.assets/0033.png](IMG/JVM.assets/0033.png)
...
![IMG/14、垃圾回收相关概念.assets/0006.png](IMG/JVM.assets/0006.png)
...
2. 哪怕是G1也不能完全避免STW情况的发生，只能说垃圾回收器越来越优秀，回收效率越来越高，尽可能地缩短了暂停时间
...
![IMG/14、垃圾回收相关概念.assets/image-20210910101637422.png](IMG/JVM.assets/image-20210910101637422.png)
...
![IMG/14、垃圾回收相关概念.assets/image-20210910101832115.png](IMG/JVM.assets/image-20210910101832115.png)
...
![IMG/14、垃圾回收相关概念.assets/image-20210910102113842.png](IMG/JVM.assets/image-20210910102113842.png)
...
![IMG/14、垃圾回收相关概念.assets/image-20210910102356847.png](IMG/JVM.assets/image-20210910102356847.png)
...
![IMG/14、垃圾回收相关概念.assets/image-20210910104835512.png](IMG/JVM.assets/image-20210910104835512.png)
...
![img](IMG/JVM.assets/0012-16516627146513.png)
...
![img](IMG/JVM.assets/image-20210910185741502.png)
...
![image-20210910191705132](IMG/JVM.assets/image-20210910191705132.png)
...
![img](IMG/JVM.assets/0004-16516627404644.png)
...
![img](IMG/JVM.assets/0011-16516627404645.png)
...
![img](IMG/JVM.assets/0012-16516627404646.png)
...
![img](IMG/JVM.assets/0013-16516627404647.png)
...
![img](IMG/JVM.assets/0014-16516627404648.png)
...
![img](IMG/JVM.assets/0016.png)

G1的分区是这样的一个区域

![img](IMG/JVM.assets/0017-16516627404649.png)
...
![img](IMG/JVM.assets/0019-165166274046510.png)
...
![img](IMG/JVM.assets/0034.jpg) ![img](IMG/JVM.assets/0024.png)
...
![img](IMG/JVM.assets/0025.png)

3、参数解析

![img](IMG/JVM.assets/0026.png)
...
![img](IMG/JVM.assets/0027.png)

3、参数解析

![img](IMG/JVM.assets/0028.png)
...
![img](IMG/JVM.assets/0029-165166274046511.png)
...
![img](IMG/JVM.assets/0030-165166274046612.png)

#### Full GC

![img](IMG/JVM.assets/0031.png)
...
![img](IMG/JVM.assets/0032-165166274046613.png)

2、然后我们将4M对象存入到Eden区中

![img](IMG/JVM.assets/0033-165166274046614.png)
...
![img](IMG/JVM.assets/0036.jpg) ![img](IMG/JVM.assets/0037.png) ![img](IMG/JVM.assets/0038-165166274046615.png)
...
![img](IMG/JVM.assets/0039-165166274046616.png)
...
![img](IMG/JVM.assets/0040-165166274046617.png)
